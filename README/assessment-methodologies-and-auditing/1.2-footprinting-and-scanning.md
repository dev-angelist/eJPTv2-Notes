...
{% content-ref url="http://127.0.0.1:5000/s/iS3hadq7jVFgSa8k5wRA/tools/nmap" %}
[Nmap](http://127.0.0.1:5000/s/iS3hadq7jVFgSa8k5wRA/tools/nmap)
{% endcontent-ref %}
...
> 📌 Check [Port Scanning lab With Nmap here](broken-reference)
